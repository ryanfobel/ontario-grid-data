...
async function startApplication() {
  ...
  const env_spec = ['https://cdn.holoviz.org/panel/wheels/bokeh-3.6.1-py3-none-any.whl', 'https://cdn.holoviz.org/panel/1.5.4/dist/wheels/panel-1.5.4-py3-none-any.whl', 'pyodide-http==0.2.1', 'holoviews', 'hvplot', 'numpy', 'pandas', 'requests', 'setuptools_git_versioning']
